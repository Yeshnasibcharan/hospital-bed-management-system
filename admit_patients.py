...
first_names_m = ['Rajesh', 'Vikram', 'Arjun', 'Sanjay', 'Deepak', 'Ravi', 'Kiran', 'Ashok', 'Suresh', 'Manoj', 'Ismael', 'Bruno']
first_names_f = ['Priya', 'Anjali', 'Kavita', 'Sunita', 'Meera', 'Pooja', 'Neha', 'Divya', 'Rekha', 'Shalini', 'Marie', 'Ceclie']
last_names = ['Ramgoolam', 'Bunwaree', 'Callychurn', 'Jugnauth', 'Seebaluck', 'Bissessur', 'Gungah', 'Naidoo', 'Appadoo', 'Ramsamy', 'Pillay', 'Veerasamy']
...
print(f"---\nTotal patients admitted: {created_count}")
